...
def mail(request):
    persons = ['Bhabatosh Mohanta', 'Rashmi Ranjan Das', 'Smita Kumari Jha']
    ...
    if request.method == 'POST':
        ...
        try:
            send_mail(subject1, 'Submission Details: \n\n' + message + '\n\n' + reply + '\n', 'rashmirdas5@gmail.com', [email], fail_silently=False)
            send_mail(subject2, message + '\n\n Assigned Person: ' + persons[num], 'rashmirdas5@gmail.com', ['rashmirdas5@gmail.com'], fail_silently=False)
        except:
            success = 0
        print(success)
        if success == 1:
